				...
				<table
					...
					<thead>
						<tr class="text-center">
							<th scope="col" class="col-1">[받는이]</th>
							<th scope="col" class="col-7">[메시지]</th>
							<th scope="col" class="col-2">[전송일시]</th>
							<th scope="col" class="col-1">[받는이 읽음]</th>
						</tr>
					</thead>
					<tbody>
						...
						<c:forEach var="message" items="${result}">
							<c:if
								...
								<tr class="text-center">
									<td><a
										href="/sendMessage?to_id=${sessionScope.id}&from_id=${message.from_id}"
										target="_blank" onclick="openWindowWithSize(500, 500);">
