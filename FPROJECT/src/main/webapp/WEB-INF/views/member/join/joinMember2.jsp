			...
			<form id="frmJoin" method="POST" action="<c:url value='/joinProcess'/>">
				<div class="mb-3">
					<label for="id" class="form-label">아이디</label> <input type="text"
						id="id" name="member_id" class="form-control" placeholder="아이디">
				</div>
				<div class="mb-3">
				...
				<div class="mb-3">
					<button type="button" onclick="daumPost()"
						class="btn btn-primary me-2">우편 주소 찾기</button>
				</div>
				<div class="mb-3">
					<label for="addr1" class="form-label">우편번호</label> <input
						type="text" id="addr1" name="member_addr1" class="form-control"
