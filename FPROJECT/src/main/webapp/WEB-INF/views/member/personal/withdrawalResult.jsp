			    ...
			    <c:choose>
			        <c:when test="${result eq '1'}">
			            <div class="container mt-5">
							...
							<div
								...
								<h1 class="text-body-emphasis fs-3">회원 탈퇴에 성공하였습니다</h1>
								<p class="col-lg-8 mx-auto fs-5 text-muted">새로마켓을 이용해주셔서 감사합니다.</p>
							</div>
			        </c:when>
			        ...
			        <c:when test="${result eq '0'}">
						<div class="container mt-5">
							...
							<div
								class="p-5 text-center justify-content-center bg-body-tertiary rounded-3">
								<h1 class="text-body-emphasis fs-3">회원 탈퇴에 실패하엿습니다.</h1>
								<p class="col-lg-8 mx-auto fs-5 text-muted">잠시 후 다시 회원 탈퇴를 진행해
									주세요</p>
							</div>
						</div>
					</c:when>
